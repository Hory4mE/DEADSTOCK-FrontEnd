...
function Compo_addProduct() {
  ...
  return (
    <div className="flex flex-col px-22 mt-7 w-full max-md:px-5 max-md:max-w-full py-5">
      <h1 className="text-sm font-bold text-black max-md:ml-2.5" style={{ marginLeft: '268px' }}>Create Product</h1>
